...
unzip ea_floodmapforplanningriversandseafloodzone2_shp_full.zip -d data/flood2
unzip ea_floodmapforplanningriversandseafloodzone3_shp_full.zip -d data/flood3